...
$searchSql = "SELECT * FROM livres_souhaites WHERE added_by = $userId ";
if ($searchTerm !== '') {
...
$userBooksSql = "SELECT * FROM livres_souhaites WHERE added_by = $userId ORDER BY titre ASC";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link text-warning" href="./mes_envies.php">Mes envies</a></li>
                    <li class="nav-item"><a class="nav-link" href="./ma_bibliotheque.php">Ma bibliothèque</a></li>
                </ul>
            </div>
        </div>
    </nav>
