...
<div class="col">
    <div class="card h-100 d-flex flex-column">
        <!-- Affiche du film -->
        <?php
        $imageSrc = $posterUrl !== null ? $posterUrl : "https://e0.pxfuel.com/wallpapers/1021/882/desktop-wallpaper-dual-monitor-firewatch-wengerluggagesave-vertical-dual-monitor.jpg";
        ?>
        <img src="<?php echo $imageSrc; ?>" class="card-img-top" alt="<?php echo $posterUrl !== null ? 'Affiche du film ' . $title : 'Image par défaut'; ?>" style="height: 325px;" loading="lazy">
