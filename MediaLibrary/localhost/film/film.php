...
<body>
    ...
    <div class="container">
        ...
        if (isset($_POST['title'])) {
            ...
            $director = $_POST['director'] != '' ? $connect->real_escape_string($_POST['director']) : 'NULL';
            $releaseYear = $_POST['release_year'] != '' ? $connect->real_escape_string($_POST['release_year']) : 'NULL';
            ...
            if ($duplicateResult->num_rows > 0) {
                ...
                if ($insertStmt->execute()) {
                    ...
                    echo '<div class="alert alert-error">Erreur lors de l\'ajout du film : ' . $connect->error . '</div>';
                }
            }
        }
        ?>
