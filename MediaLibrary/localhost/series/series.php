...
<body>
    ...
    <div class="container">
        ...
        if (isset($_POST['title'])) {
            ...
            $language = $_POST['language'] != '' ? $connect->real_escape_string($_POST['language']) : '/';
            ...
            if ($duplicateResult->num_rows > 0) {
                ...
                if ($insertStmt->execute()) {
                    ...
                    echo '<div class="alert alert-error">Erreur lors de l\'ajout de la série : ' . $connect->error . '</div>';
                }
            }
        }
        ?>
