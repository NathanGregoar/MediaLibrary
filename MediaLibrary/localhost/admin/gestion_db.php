...
<body>
    <div class="navbar">
        ...
        <a href="./gestion_db.php" style="color: #ff0000;">Gestion DB</a>
            ...
            switch ($action) {
                case 'ajouter_table':
                    ...
                    if (mysqli_query($connect, $sql)) {
                        ...
                        echo '<div class="alert error">Erreur lors de la création de la table: ' . mysqli_error($connect) . '</div>';
                    }
                    break;
                ...
                case 'supprimer_table':
                    ...
                    if (mysqli_query($connect, $sql)) {
                        ...
                        echo '<div class="alert error">Erreur lors de la suppression de la table: ' . mysqli_error($connect) . '</div>';
                    }
                    break;
                ...
                case 'ajouter_colonne':
                    ...
                    if (mysqli_query($connect, $sql)) {
                        ...
                        echo '<div class="alert error">Erreur lors de l\'ajout de la colonne: ' . mysqli_error($connect) . '</div>';
                    }
                    break;
                ...
                case 'supprimer_colonne':
                    ...
                    if (mysqli_query($connect, $sql)) {
                        ...
                        echo '<div class="alert error">Erreur lors de la suppression de la colonne: ' . mysqli_error($connect) . '</div>';
                    }
                    break;
                ...
                case 'modifier_colonne':
                    ...
                    if (mysqli_query($connect, $sql)) {
                        ...
                        echo '<div class="alert error">Erreur lors de la modification de la colonne: ' . mysqli_error($connect) . '</div>';
                    }
                    break;
    ...
    <div class="right-section">
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $result_columns = mysqli_query($connect, $sql_columns);
