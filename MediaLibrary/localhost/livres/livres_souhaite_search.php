...
if (isset($_POST['delete'])) {
    ...
    if ($connect->query($deleteSql) === TRUE) {
        ...
        $deleteAlert = '<div class="alert alert-error">Erreur lors de la suppression du livre souhaité : ' . $connect->error . '</div>';
    }
}
...
if (isset($_POST['update'])) {
    $updateId = $connect->real_escape_string($_POST['book_id']);
    $updateTitle = $connect->real_escape_string($_POST['title']);
    $updateAuteur = $connect->real_escape_string($_POST['auteur']);
    $updateNumeroTome = $connect->real_escape_string($_POST['numero_tome']);
    $updateNombreTotalTomes = $connect->real_escape_string($_POST['nombre_total_tomes']);
    $updatePrix = $connect->real_escape_string($_POST['prix']);
    $updateFormat = $connect->real_escape_string($_POST['format']);
    $updateMaisonEdition = $connect->real_escape_string($_POST['maison_edition']);
    $updateResumeLivre = $connect->real_escape_string($_POST['resume_livre']);
    ...
    if ($connect->query($updateSql) === TRUE) {
        ...
        $updateAlert = '<div class="alert alert-error">Erreur lors de la mise à jour du livre souhaité : ' . $connect->error . '</div>';
    }
}
