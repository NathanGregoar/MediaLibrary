...
<body>
  <div class="container">
    <div class="navbar">
      <a href="../accueil/index.php" <?php if (basename($_SERVER['PHP_SELF']) == 'index.php') echo 'class="active"'; ?>>Accueil</a>
      <a href="./film.php" <?php if (basename($_SERVER['PHP_SELF']) == 'film.php') echo 'class="active"'; ?>>Ajouter un Film</a>
      <a href="./film_search.php" <?php if (basename($_SERVER['PHP_SELF']) == 'film_search.php') echo 'class="active"'; ?>>Consulter les Films</a>
    </div>
