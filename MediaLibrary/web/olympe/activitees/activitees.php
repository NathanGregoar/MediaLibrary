    ...
    <form method="post" class="form-container">
        <div class="form-grid">
            <div class="input-group">
                ...
                <div>
                    <input type="checkbox" id="activite_1" name="activite_1" value="Activité1">
                    <label for="activite_1">Activité 1</label>
                </div>
                <div>
                    <input type="checkbox" id="activite_2" name="activite_2" value="Activité2">
                    <label for="activite_2">Activité 2</label>
                </div>
                <div>
                    <input type="checkbox" id="activite_3" name="activite_3" value="Activité3">
